...
public:
    ...
    void setupUi(QMainWindow *Editor)
    {
        ...
        menuColor_scheme = new QMenu(menuSettings);
        ...
        menuSettings->addAction(menuColor_scheme->menuAction());
        menuSettings->addAction(actionFont);
        menuColor_scheme->addAction(actionLightScheme);
        menuColor_scheme->addAction(actionDarkScheme);
        menuColor_scheme->addAction(actionSolarizedTheme);
    ...
    void retranslateUi(QMainWindow *Editor)
    {
        ...
        menuColor_scheme->setTitle(QCoreApplication::translate("Editor", "Color scheme", nullptr));
